...
namespace ProyectoControlDeParqueos.Controllers
{
    public class AuditoriasController : Controller
    {
        ...
        public AuditoriasController(LoginDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdAuditoria,Accion,Usuario,FechaAccion")] Auditoria auditoria)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdAuditoria,Accion,Usuario,FechaAccion")] Auditoria auditoria)
        {
